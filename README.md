...
Generated from: https://api.apis.guru/v2/specs/azure.com/sql-ManagedServerSecurityAlertPolicy/2017-03-01-preview/swagger.json<br/>
...
**flow**ground :- Telekom iPaaS / azure-com-sql-managed-server-security-alert-policy-connector<br/>
